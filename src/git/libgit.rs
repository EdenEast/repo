...
use git2::{
    build::CheckoutBuilder, AutotagOption, Branch, BranchType, Config, FetchOptions, MergeAnalysis,
    MergeOptions, Object, ObjectType, ProxyOptions, RemoteCallbacks, Repository, ResetType,
};
    ...
    P: AsRef<Path>,
{
    ...
    for iter in remotes.iter() {
        ...
        remote.update_tips(None, true, AutotagOption::All, None)?;
    }
